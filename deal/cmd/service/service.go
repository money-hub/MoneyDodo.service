...
import (
	...
	http "github.com/money-hub/MoneyDodo.service/deal/pkg/http"
...
var fs = flag.NewFlagSet("deal", flag.ExitOnError)
var debugAddr = fs.String("debug.addr", ":8080", "Debug and metrics listen address")
var httpAddr = fs.String("http-addr", ":8007", "HTTP listen address")
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "deal")
