...
import (
	...
	http "github.com/money-hub/MoneyDodo.service/comment/pkg/http"
...
var fs = flag.NewFlagSet("comment", flag.ExitOnError)
var debugAddr = fs.String("debug.addr", ":8080", "Debug and metrics listen address")
var httpAddr = fs.String("http-addr", ":8006", "HTTP listen address")
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "comment")
